...
//    \"https://bathroomreview.herokuapp.com/assignment7/results\"
    ...
    out.println("            <input type=\"radio\" name=\"cleanliness\" id=\"slightlyMessy\" value=\"slightlyMessy\" />");
    out.println("    <label for=\"slightlyMessy\">Slightly Messy</label>");
    out.println("            <input type=\"radio\" name=\"cleanliness\" id=\"mostlyClean\" value=\"mostlyClean\" />");
    out.println("    <label for=\"mostlyClean\">Mostly Clean</label>");
    out.println("            <input type=\"radio\" name=\"cleanliness\" id=\"completelyClean\" value=\"completelyClean\" />");
